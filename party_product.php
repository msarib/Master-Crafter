                            ...
                            <div class="col-xs-12">
                                <div class="page-title-box">
                        		  ...
                        		  <div class="row">
                                    <div class="container">
                <div class="col-lg-12">
         <a href="Product.php"> <button class="btn btn-success waves-effect waves-light m-b-5"> <i class="fa fa-plus-square m-r-5"></i> <span>New Product</span> </button></a> </div> </div>
                            <div class="col-sm-12">
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            $QUERY = "SELECT A.*,PT.PARTY_NAME,B.STATUS_NAME,BR.NAME AS BRAND_NAME,CAT.CAT_NAME AS CATE_NAME,
                                             ...
                                             WHERE A.PARTY_CODE = '".$_SESSION["id"]."' ";
                                       ...
                                       while($row = mysqli_fetch_array($result)) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                             ...
                                             <a href="edit_product.php?ITEM_CODE=<?php echo $row["ITEM_CODE"]; ?>" class="edit" 
                                                  ><img src="../icons/Edit_icon.ico" style="height: 25px; width: 25px;" /></a>
