...
$query=" select A.ID,A.NAME,A.STATUS_ID,B.STATUS_NAME FROM tbl_brand A LEFT OUTER JOIN tbl_status B on A.STATUS_ID = B.STATUS_ID"; 
...
<td> 
<a href="javascript:void(0)" class="btn btn-primary edit" data-idd="tbl_brand" data-id="<?php echo $array[0];?>">Edit</a>
