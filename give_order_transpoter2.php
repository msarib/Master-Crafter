...
$ip_address = gethostbyname("www.google.com");  
    ...
    $updates="update tbl_order_master set status='Accepted',CHARGES='$CHARGES'  WHERE ORDER_ID = '".$ORDER_ID."'";
    $run_updates=mysqli_query($con,$updates);
        ...
        if($query!="")
        {
            ...
            echo '<script> alert("Transporter Give Order Is Successfully!");</script>';
             echo "<script>window.location='Party_Order_Detail.php'</script>";
        } 
        else
        {
            echo 'Not Updated';
    	...
    	<div class="container">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Order Transfer (Order Area  : <?php echo $areaname ?>)</h4>
                        			...
                        			<div class="row">
                        				<div class="col-lg-12">
                                             ...
                                             $result1 = mysqli_query($conn,"SELECT * FROM tbl_party_list where STATUS_ID = '1' AND PNATURE_CODE = 3 ");
                                                    ...
                                                    {
                                                        echo '<option value="' .$row['PARTY_CODE'] .'">' .$row['PARTY_NAME'] .'( Area : '.$row['area_name'].' )</option>';
                                                    }
                                                ?>
                                                      </select>
                                                  </div>
