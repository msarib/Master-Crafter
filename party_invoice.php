                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="pull-left m-t-30">
                                                    <address>
                                                     ...
                                                     DHA PHASE - v KAYABAN E ITEHAD ,KARACHI, PAKISTAN<br>
                                                      <abbr title="Phone">P:</abbr>  +92 335 3509 521
                                                      </address>
                                                </div>
                                       ...
                                       LEFT OUTER JOIN tbl_unit C ON B.UNIT_ID = C.ID WHERE A.ORDER_MID = '".$ORDER_ID."' AND A.PARTY_CODE = '".$_SESSION["id"]."' ";
                                       $result = mysqli_query($conn,$QUERY); 
                                       while($row = mysqli_fetch_array($result)) { ?>
