                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 id="userModel" class="modal-title">Class</h4>
                                                </div>
                                              ...
                                              <div class="form-group">
                                                <label for="field-1" class="control-label">Class Name</label>
                                                  <input type="text" class="form-control" id="name" name="name">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="field-4" class="control-label">Class Status</label>
                             ...
                             <div class="row">
                              <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <button type="button" id="addNewUser" style="margin-top: -20px;" class="btn btn-success" >Add Class</button>   
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                        	<?php 
                                       $result = mysqli_query($conn,"SELECT A.ID ,A.NAME,A.STATUS_ID,B.STATUS_NAME FROM tbl_class A
                                           ...
                                           while($row = mysqli_fetch_array($result)){ ?>
                                            ...
                                            <td><?php echo $row["STATUS_NAME"] ?></td>
                                                  ...
                                                  <td><a href="javascript:void(0)" data-toggle="modal" class="edit" data-idd="tbl_class" data-id="<?php echo $row[0];?>" 
												...
												<a href="javascript:void(0)" data-toggle="modal" class="delete" data-idd="tbl_class" data-id="<?php echo $row[0];?>" 
